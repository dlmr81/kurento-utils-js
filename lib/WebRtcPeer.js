...
function WebRtcPeer(mode, options, callback) {
  ...
  var receiveConstraints = options.receiveConstraints || options.mediaConstraints;
  ...
  this.generateOffer = function (callback) {
    ...
    if (receiveConstraints) {
      offerAudio = (typeof receiveConstraints.audio === 'boolean') ?
        receiveConstraints.audio : true
      offerVideo = (typeof receiveConstraints.video === 'boolean') ?
        receiveConstraints.video : true
    }
    ...
    pc.createOffer(constraints).then(function (offer) {
      ...
      if(browser.name === 'Chrome' || browser.name === 'Chromium') {
          offer = offer.replace(/a=rtpmap:\d+ rtx\/\d+\r\n/i, "");
          offer = offer.replace(/a=fmtp:\d+ apt=\d+\r\n/i, "");
      }
      if(offer.indexOf('a=rtpmap:120 VP8/90000') >= 0 && offer.indexOf('a=rtpmap:100 VP8/90000') >= 0){
          offer = offer.replace(/a=rtpmap:120 VP8\/90000\r\n/i, "");
          offer = offer.replace(/a=rtcp-fb:120 nack\r\n/i,"");
          offer = offer.replace(/a=rtcp-fb:120 nack pli\r\n/i,"");
          offer = offer.replace(/a=rtcp-fb:120 ccm fir\r\n/i,"");
      }
